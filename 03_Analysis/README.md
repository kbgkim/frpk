...
<!-- FRKP-NAV-START -->
[Financial Risk Knowledge Platform](../README.md) > [Home](../README.md) > [03_Analysis](README.md)
...
## Purpose
Analytical documents explaining why risk frameworks, methods, or legacy approaches succeed or fail within the FRKP knowledge structure.

## Scope
- Framework analysis and rationale
- Method limitations and design tradeoffs
- Historical or regulatory motivation
- Cross-bundle analytical context
...
| Folder | Relationship |
|---|---|
| 01_Reference_Library | Analysis documents cite source material from the reference library. |
| 02_Knowledge_Base | Analysis documents expand on concepts introduced in the knowledge base. |
| 04_Formula_Catalog | Formula documents may depend on analytical conclusions. |
| 08_Bundles | Bundle reviews verify that required analysis documents are placed here. |