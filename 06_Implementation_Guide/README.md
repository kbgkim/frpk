...
<!-- FRKP-NAV-START -->
[Financial Risk Knowledge Platform](../README.md) > [Home](../README.md) > [06_Implementation_Guide](README.md)
...
## Purpose
Implementation guidance that turns FRKP formulas and frameworks into reproducible calculation procedures and system-ready behavior.

## Scope
- Calculation workflows and processing steps
- Input, validation, and output contracts
- Implementation considerations and traceability
- Links from formulas to architecture
...
| Folder | Relationship |
|---|---|
| 04_Formula_Catalog | Implementation guides operationalize formula catalog entries. |
| 05_Mathematical_Foundation | Mathematical foundations clarify quantitative behavior where needed. |
| 07_Architecture | Architecture documents map implementation guidance to system components. |
| 08_Bundles | Bundle reviews verify required implementation guides are complete. |