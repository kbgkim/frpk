...
<!-- FRKP-NAV-START -->
[Financial Risk Knowledge Platform](../README.md) > [Home](../README.md) > [07_Architecture](README.md)
...
## Purpose
Design documentation for the risk engine and any software components associated with the FRKP. Covers system architecture, component design, data flows, and integration patterns.

## Scope
- Risk engine architecture and design decisions
...
| Folder | Relationship |
|---|---|
| 04_Formula_Catalog | Engine components implement formulas from the catalog. |
| 05_Mathematical_Foundation | Architecture decisions are grounded in mathematical foundations. |
| 11_Volumes (planned) | Architecture decisions are explained in relevant volumes. |
| 12_Appendix (planned) | Supporting technical diagrams and supplementary material. |
