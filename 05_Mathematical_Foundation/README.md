...
<!-- FRKP-NAV-START -->
[Financial Risk Knowledge Platform](../README.md) > [Home](../README.md) > [05_Mathematical_Foundation](README.md)
...
## Purpose
Supporting mathematical derivations, definitions, and quantitative foundations used by FRKP formula and implementation documents.

## Scope
- Mathematical definitions and derivations
- Quantitative assumptions and notation
- Just-in-time foundation documents required by bundles
- Cross-references to formulas and implementation guidance
...
| Folder | Relationship |
|---|---|
| 01_Reference_Library | Mathematical foundations reference authoritative source material. |
| 04_Formula_Catalog | Formula documents cite mathematical foundations when a deeper derivation is required. |
| 06_Implementation_Guide | Implementations use foundation documents to preserve mathematical intent. |
| 08_Bundles | Bundle reviews track whether optional mathematical foundation documents are required. |