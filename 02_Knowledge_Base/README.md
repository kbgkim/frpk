...
<!-- FRKP-NAV-START -->
[Financial Risk Knowledge Platform](../README.md) > [Home](../README.md) > [02_Knowledge_Base](README.md)
...
## Purpose
Structured repository of financial risk knowledge articles, how-to guides, FAQs, and decision trees. The primary living knowledge asset of the platform.

## Scope
- Risk management concepts and frameworks
- How-to guides and standard operating procedures
- FAQs and troubleshooting guides
- Cross-referenced topic clusters
...
| Folder | Relationship |
|---|---|
| 04_Formula_Catalog | KB articles may reference formulas by ID. |
| 10_Glossary (planned) | All terms used in KB articles are defined in the Glossary. |
| 05_Mathematical_Foundation | Mathematical foundations provide the deep-dive treatment; KB provides summary/quick-reference. |
| 11_Volumes (planned) | Volumes provide the deep-dive treatment; KB provides summary/quick-reference. |
