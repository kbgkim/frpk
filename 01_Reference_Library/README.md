...
<!-- FRKP-NAV-START -->
[Financial Risk Knowledge Platform](../README.md) > [Home](../README.md) > [01_Reference_Library](README.md)
...
## Purpose
Curated collection of external reference materials — papers, regulatory documents, industry standards, textbooks, and authoritative sources used as input or citation for the FRKP.

## Scope
- PDFs, links, and summaries of external references
- Annotated bibliographies
- Regulatory frameworks (Basel, IFRS, ISO, etc.)
...
| Folder | Relationship |
|---|---|
| 04_Formula_Catalog | Formulas cite sources from this library. |
| 10_Glossary (planned) | Term definitions may reference materials here. |
| 05_Mathematical_Foundation | Mathematical foundations reference authoritative sources catalogued here. |
| 11_Volumes (planned) | Volume content references authoritative sources catalogued here. |
| 07_Architecture | Architecture documentation references authoritative sources catalogued here. |
